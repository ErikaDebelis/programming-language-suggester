$(document).ready(function() {
  $("form#suggester").submit(function(event) {
    ...
    if ((spend === "music" && color === "p-color" && vacation === "tokyo" && animal === "meerkat" && entertainment === "games") || (spend === "music" && color === "j-color" && vacation === "tokyo" && animal === "meerkat" && entertainment === "games") || (spend === "food" && color === "p-color" && vacation === "tokyo" && animal === "meerkat" && entertainment === "games") || (spend === "music" && color === "p-color" && vacation === "tokyo" && animal === "leopard" && entertainment === "podcast")) {
      $('#csharp').show();
